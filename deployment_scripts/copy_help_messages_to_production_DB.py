...
prod_key = {
             ...
             "private_key": os.environ['FIREBASE_SERVICE_ACCOUNT_CEVIZH11_MENUPLANUNG__PRIVATE_KEY'],
...
def_key = {
            ...
            "private_key": os.environ['FIREBASE_SERVICE_ACCOUNT_CEVIZH11__PRIVATE_KEY'],
