 ...
 *
 */
export const isAuthenticated: Rule = rule('isAuthenticated')(
  async (_, __, ctx: GraphQLContext) => {
 ...
 *
 */
export const hasUserId: Rule = rule('hasUserId')(async (_, __, ctx: GraphQLContext) => {
 ...
 *
 */
export const apiKeyOnly: Rule = rule('apiKeyOnly')((_, __, ctx: GraphQLContext) => {
