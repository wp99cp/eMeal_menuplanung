...
const WelcomeStepContent: (args: StepperCardArgs) => JSX.Element = () => (
  <>
    ...
    <p className="text-gray-600 my-2 font-medium">
      Du meldest dich das erste Mal an. Im Folgenden werden wir ein paar Dinge
      für dich einrichten.
    </p>
    <p className="text-gray-500">
      Keine Angst, falls du beim "alten" eMeal - Menüplanung bereits einen
      Account hattest, so werden wir deine Daten während dem Einrichten
