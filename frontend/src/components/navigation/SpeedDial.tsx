    ...
    >
      {isMenuOpen && (
        ...
        >
          <button
            type="button"
            onClick={() => setDarkMode(toggleDarkMode(darkMode))}
      ...
      <button
        ...
        aria-expanded="false"
        className="flex h-12 w-12 items-center justify-center rounded-lg bg-orange-500 text-white hover:bg-orange-600 focus:outline-none"
      >
